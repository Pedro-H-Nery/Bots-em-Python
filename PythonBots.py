...
def baixaArquivo():
    ...
    time.sleep(2)
    navegador.find_element("xpath", '//*[@id="conteudo"]/div[3]/form/table[1]/tbody/tr[1]/td/input').send_keys('User')
    navegador.find_element("xpath", '//*[@id="conteudo"]/div[3]/form/table[1]/tbody/tr[2]/td/input').send_keys('senha')
